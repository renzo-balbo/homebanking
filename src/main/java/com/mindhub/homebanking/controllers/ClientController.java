...
public class ClientController {
    ...
    public ResponseEntity<Object>register(
        ...
        String mailBody = "Hey! We are so close to complete your account registration, just one more thing to do. We need you to go to this link: https://homebanking-rlbp.herokuapp.com/web/verification.html?id="+client.getId();
